...
return [
    ...
    "categories" => [
        [
            ...
            "image"             => '/images/categories/uplus.png',
        ],
        [
            "id"                => 2,
            "name"              => 'Scope',
            ...
            "image"             => '/images/categories/scope.png',
        ],
        [
            "id"                => 3,
            "name"              => 'Varta',
            ...
            "image"             => '/images/categories/varta.png',
        ],
        [
            "id"                => 4,
            "name"              => 'Quantum',
            ...
            "image"             => '/images/categories/quantum.png',
        ],
        [
            "id"                => 5,
            "name"              => 'Asashi',
            ...
            "image"             => '/images/categories/asashi.png',
        ],
        [
            "id"                => 6,
            "name"              => 'Fukuda',
            ...
            "image"             => '/images/categories/fukuda.png',
        ],
        [
            "id"                => 7,
            "name"              => 'Motolite',
            ...
            "image"             => '/images/categories/motolite.png',
        ],
    ],
    "products"   => [
        [
