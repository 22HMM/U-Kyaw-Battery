...
var DOC = document;
DOC.addEventListener('DOMContentLoaded', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var toggleButton, closeMenu, energyBtn, leftPart, rightPart, contactForm, contactSubmitButton;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        // Dynamically import flowbite
        __webpack_require__.e(/*! import() */ "node_modules_flowbite_lib_esm_index_js").then(__webpack_require__.bind(__webpack_require__, /*! flowbite */ "./node_modules/flowbite/lib/esm/index.js"))["catch"](function (err) {
          return console.warn('Flowbite failed to load:', err);
        });
        ...
        closeMenu = this.querySelector('#close-menu');
        ...
        if (energyBtn) {
          leftPart = energyBtn.querySelector('.left-part');
          rightPart = energyBtn.querySelector('.right-part');
         ...
         */
        contactForm = this.querySelector('#contact-form');
        contactSubmitButton = this.querySelector('#contact-submit-button');
...
/******/ 			if (chunkId === "node_modules_flowbite_lib_esm_index_js") return "public/js/" + chunkId + ".js";
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "U Kyaw Battery:";
