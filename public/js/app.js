...
DOC.addEventListener('DOMContentLoaded', function () {
  ...
  var toggleButton = this.querySelector('#toggle-button');
  if (toggleButton) {
  ...
  var closeMenu = this.querySelector('#close-menu');
   ...
   */
  var energyBtn = document.querySelector('.energy-btn');
  var leftPart = energyBtn.querySelector('.left-part');
  var rightPart = energyBtn.querySelector('.right-part');
  energyBtn.addEventListener('mouseleave', function () {
  ...
  energyBtn.addEventListener('mouseenter', function () {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkU_Kyaw_Battery"] = self["webpackChunkU_Kyaw_Battery"] || [];
